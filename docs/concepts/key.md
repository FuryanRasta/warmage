...
The MAGEhub coin_type is same as cosmos stake token `ATOM` 118 registered in [SLIP44](https://github.com/satoshilabs/slips/blob/master/slip-0044.md).

So the prefix of MAGEhub key BIP44 path is `44'/118'/`, and its default path is `44'/118'/0'/0/0`.
