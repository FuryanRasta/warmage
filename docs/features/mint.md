...
The value of `inflationBasement` is specified in genesis file. By default its value `2000000000mage`(2 billion mage, `1 mage` equals `1*10^18 umage`), and its value will never be changed.
Suppose `blockCostTime` is 5000 millisecond, and `inflationRate` is `4%`, then the inflation amount will be `12675235125611580094umage` (`12.675235125611580094mage`)
...
```bash
mage q staking pool --node=<mage-node-url>
```
