...
### step 4
  ...
  The secret will be disclosed while the HTLC is claimed successfully by Bob on Bitcoin. Alice will perfom the same claim to the locked MAGE with the secret before the expiration time on MAGE Hub.

## MAGEhub HTLC Specification
...
- [Create HTLC](../cli-client/htlc.md#mage-tx-htlc-create)

- [Claim HTLC](../cli-client/htlc.md#mage-tx-htlc-claim)

- [Query HTLC](../cli-client/htlc.md#mage-query-htlc-htlc)
