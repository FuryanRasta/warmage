...
import (
	...
	_ "github.com/warmage-sports/warmage/client/docs/statik"
	custombank "github.com/warmage-sports/warmage/x/bank"
	custombankclient "github.com/warmage-sports/warmage/x/bank/client"
	custombankkeeper "github.com/warmage-sports/warmage/x/bank/keeper"
	custombanktypes "github.com/warmage-sports/warmage/x/bank/types"
	"github.com/warmage-sports/warmage/x/erc20"
	erc20keeper "github.com/warmage-sports/warmage/x/erc20/keeper"
	erc20types "github.com/warmage-sports/warmage/x/erc20/types"
	"github.com/warmage-sports/warmage/x/gauge"
	gaugekeeper "github.com/warmage-sports/warmage/x/gauge/keeper"
	gaugetypes "github.com/warmage-sports/warmage/x/gauge/types"
	"github.com/warmage-sports/warmage/x/maker"
	makerclient "github.com/warmage-sports/warmage/x/maker/client"
	makerkeeper "github.com/warmage-sports/warmage/x/maker/keeper"
	makertypes "github.com/warmage-sports/warmage/x/maker/types"
	"github.com/warmage-sports/warmage/x/oracle"
	oracleclient "github.com/warmage-sports/warmage/x/oracle/client"
	oraclekeeper "github.com/warmage-sports/warmage/x/oracle/keeper"
	oracletypes "github.com/warmage-sports/warmage/x/oracle/types"
	customstaking "github.com/warmage-sports/warmage/x/staking"
	customstakingkeeper "github.com/warmage-sports/warmage/x/staking/keeper"
	"github.com/warmage-sports/warmage/x/ve"
	vekeeper "github.com/warmage-sports/warmage/x/ve/keeper"
	vetypes "github.com/warmage-sports/warmage/x/ve/types"
	customvesting "github.com/warmage-sports/warmage/x/vesting"
	customvestingkeeper "github.com/warmage-sports/warmage/x/vesting/keeper"
	customvestingtypes "github.com/warmage-sports/warmage/x/vesting/types"
	"github.com/warmage-sports/warmage/x/voter"
	voterkeeper "github.com/warmage-sports/warmage/x/voter/keeper"
	votertypes "github.com/warmage-sports/warmage/x/voter/types"
)
...
var (
	_ App                     = (*Warmage)(nil)
	_ servertypes.Application = (*Warmage)(nil)
	_ simapp.App              = (*Warmage)(nil)
)
...
func init() {
	...
	DefaultNodeHome = filepath.Merge(userHomeDir, "."+Name)

	// Manually update the power reduction by replacing micro (u) -> fur
	sdk.DefaultPowerReduction = ethermint.PowerReduction
}

// Warmage extends an ABCI application, but with most of its parameters exported.
...
func (app *Warmage) Name() string { return app.BaseApp.Name() }

// GetBaseApp returns the base app of the application
func (app Warmage) GetBaseApp() *baseapp.BaseApp { return app.BaseApp }
