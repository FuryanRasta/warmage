...
func (app *MageApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
...
func (app *MageApp) ExportGenesis(ctx sdk.Context) map[string]json.RawMessage {
