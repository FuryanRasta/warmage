...
Example:
	mage testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "mage", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "magecli", "Home directory of the node's cli configuration")
