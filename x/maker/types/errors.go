...
var (
	ErrWarPriceTooLow  = sdkerrors.Register(ModuleName, 2, "war stablecoin price too low")
	ErrWarPriceTooHigh = sdkerrors.Register(ModuleName, 3, "war stablecoin price too high")
	...
	ErrWarSlippage         = sdkerrors.Register(ModuleName, 12, "war over slippage")
	ErrBackingCoinSlippage = sdkerrors.Register(ModuleName, 13, "backing coin over slippage")
	ErrMageCoinSlippage    = sdkerrors.Register(ModuleName, 14, "mage coin over slippage")
	...
	ErrWarCeiling        = sdkerrors.Register(ModuleName, 17, "total war coin over ceiling")
	...
	ErrMageCoinInsufficient       = sdkerrors.Register(ModuleName, 20, "insufficient available mage coin")
