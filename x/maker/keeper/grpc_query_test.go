...
func (suite *KeeperTestSuite) TestAllBackingPools() {
	...
	poolBacking := types.PoolBacking{
		WarMinted:  sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(100)),
		Backing:    sdk.NewCoin(suite.bcDenom, sdk.NewInt(10)),
		MageBurned: sdk.NewCoin(warmage.AttoMageDenom, sdk.NewInt(1000)),
	}
	...
	poolBacking2 := types.PoolBacking{
		WarMinted:  sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(200)),
		Backing:    sdk.NewCoin("eth", sdk.NewInt(20)),
		MageBurned: sdk.NewCoin(warmage.AttoMageDenom, sdk.NewInt(2000)),
	}
...
func (suite *KeeperTestSuite) TestAllCollateralPools() {
	...
	poolColl := types.PoolCollateral{
		...
		WarDebt:            sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(100)),
		MageCollateralized: sdk.NewCoin(warmage.AttoMageDenom, sdk.NewInt(1000)),
	}
	...
	poolColl2 := types.PoolCollateral{
		...
		WarDebt:            sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(200)),
		MageCollateralized: sdk.NewCoin(warmage.AttoMageDenom, sdk.NewInt(2000)),
	}
...
func (suite *KeeperTestSuite) TestCollateralOfAccount() {
	...
	accColl := types.AccountCollateral{
		...
		WarDebt:             sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(200)),
		MageCollateralized:  sdk.NewCoin(warmage.AttoMageDenom, sdk.NewInt(1000)),
		LastInterest:        sdk.NewCoin(warmage.MicroUSFDenom, sdk.NewInt(10)),
...
func (suite *KeeperTestSuite) TestTotalBacking() {
	...
	expRes := &types.QueryTotalBackingResponse{
		TotalBacking: types.TotalBacking{
			...
			WarMinted:    sdk.Coin{"", sdk.ZeroInt()},
			MageBurned:   sdk.Coin{"", sdk.ZeroInt()},
		},
	}
	suite.Require().NoError(err)
	suite.Require().Equal(expRes, res)
...
func (suite *KeeperTestSuite) TestTotalCollateral() {
	...
	expRes := &types.QueryTotalCollateralResponse{
		TotalCollateral: types.TotalCollateral{
			WarDebt:            sdk.Coin{"", sdk.ZeroInt()},
			MageCollateralized: sdk.Coin{"", sdk.ZeroInt()},
		},
	}
	suite.Require().NoError(err)
	suite.Require().Equal(expRes, res)
