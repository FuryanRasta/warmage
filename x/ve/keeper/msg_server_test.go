...
func (suite *KeeperTestSuite) TestVeCreate() {
	...
	testCases := []struct {
		...
		{"invalid denom", false, sender, receiver.String(), "1mage", types.RegulatedPeriod},
		{"invalid sender", false, []byte("xxx"), receiver.String(), denom, types.RegulatedPeriod},
		{"invalid receiver", false, sender, "xxx", "1amage", types.RegulatedPeriod},
...
func (suite *KeeperTestSuite) TestVeDeposit() {
	...
	testCases := []struct {
		...
		{"invalid denom", false, sender, sdk.NewCoin("mage", sdk.NewInt(1)), "ve-100"},
