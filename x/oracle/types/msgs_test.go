...
func TestMsgAggregateExchangeRatePrevote(t *testing.T) {
	...
	exchangeRates := sdk.DecCoins{sdk.NewDecCoinFromDec(warmage.AttoMageDenom, sdk.OneDec()), sdk.NewDecCoinFromDec(warmage.MicroUSFDenom, sdk.NewDecWithPrec(32121, 1))}
