...
import { EventCreate } from "./module/types/merlion/ve/v1/event"
import { EventDeposit } from "./module/types/merlion/ve/v1/event"
import { EventExtendTime } from "./module/types/merlion/ve/v1/event"
import { EventMerge } from "./module/types/merlion/ve/v1/event"
import { EventWithdraw } from "./module/types/merlion/ve/v1/event"
import { Params } from "./module/types/merlion/ve/v1/genesis"
import { LockedBalance } from "./module/types/merlion/ve/v1/ve"
import { Checkpoint } from "./module/types/merlion/ve/v1/ve"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: merlion.ve.v1 initialized!')
		...
		async QueryTotalVotingPower({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryTotalVotingPower', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryVotingPower({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryVotingPower', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryVeNfts({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryVeNfts', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryVeNft({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryVeNft', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgCreate({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgCreate', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgDeposit({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgDeposit', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgExtendTime({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgExtendTime', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgMerge({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgMerge', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgWithdraw({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgWithdraw', 'API Node Unavailable. Could not perform query: ' + e.message)
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgMerge:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgMerge:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgExtendTime:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgExtendTime:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgWithdraw:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgWithdraw:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
		...
		async MsgMerge({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgMerge:Create', 'Could not create message: ' + e.message)
		...
		async MsgExtendTime({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgExtendTime:Create', 'Could not create message: ' + e.message)
		...
		async MsgWithdraw({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgWithdraw:Create', 'Could not create message: ' + e.message)
