...
import { Params } from "./module/types/merlion/vesting/v1/genesis"
import { AllocationAmounts } from "./module/types/merlion/vesting/v1/genesis"
import { AllocationAddresses } from "./module/types/merlion/vesting/v1/genesis"
import { Airdrop } from "./module/types/merlion/vesting/v1/vesting"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: merlion.vesting.v1 initialized!')
		...
		async QueryAirdrops({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAirdrops', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryAirdrop({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAirdrop', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgAddAirdrops({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgAddAirdrops', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgExecuteAirdrops({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgExecuteAirdrops', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgSetAllocationAddress({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgSetAllocationAddress', 'API Node Unavailable. Could not perform query: ' + e.message)
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgSetAllocationAddress:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgSetAllocationAddress:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgAddAirdrops:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgAddAirdrops:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgExecuteAirdrops:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgExecuteAirdrops:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
		...
		async MsgSetAllocationAddress({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgSetAllocationAddress:Create', 'Could not create message: ' + e.message)
		...
		async MsgAddAirdrops({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgAddAirdrops:Create', 'Could not create message: ' + e.message)
		...
		async MsgExecuteAirdrops({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgExecuteAirdrops:Create', 'Could not create message: ' + e.message)
