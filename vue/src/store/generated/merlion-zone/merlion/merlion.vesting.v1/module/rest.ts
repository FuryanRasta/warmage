...
/**
 * @title merlion/vesting/v1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/merlion/vesting/v1/airdrops
   */
  queryAirdrops = (
    query?: {
      completed?: boolean;
    ...
    this.request<V1QueryAirdropsResponse, RpcStatus>({
      path: `/merlion/vesting/v1/airdrops`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/merlion/vesting/v1/airdrops/{targetAddr}
   */
  queryAirdrop = (targetAddr: string, query?: { completed?: boolean }, params: RequestParams = {}) =>
    this.request<V1QueryAirdropResponse, RpcStatus>({
      path: `/merlion/vesting/v1/airdrops/${targetAddr}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/merlion/vesting/v1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1QueryParamsResponse, RpcStatus>({
      path: `/merlion/vesting/v1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
...
Should only be called by core team multisig.
 * @request GET:/merlion/vesting/v1/tx/exec_airdrops
 */
  msgExecuteAirdrops = (query?: { sender?: string; maxCount?: string }, params: RequestParams = {}) =>
    this.request<V1MsgExecuteAirdropsResponse, RpcStatus>({
      path: `/merlion/vesting/v1/tx/exec_airdrops`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
 ...
 * @request GET:/merlion/vesting/v1/tx/set_allocation_address
 */
  msgSetAllocationAddress = (
    query?: { sender?: string; teamVestingAddr?: string; strategicReserveCustodianAddr?: string },
    params: RequestParams = {},
  ) =>
    this.request<V1MsgSetAllocationAddressResponse, RpcStatus>({
      path: `/merlion/vesting/v1/tx/set_allocation_address`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
