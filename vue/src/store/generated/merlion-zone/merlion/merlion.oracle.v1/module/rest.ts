...
export interface V1AggregateExchangeRateVote {
  exchangeRateTuples?: V1ExchangeRateTuple[];
  voter?: string;
}
...
export interface V1QueryAggregatePrevoteResponse {
   ...
   */
  aggregatePrevote?: V1AggregateExchangeRatePrevote;
}
...
export interface V1QueryAggregatePrevotesResponse {
   ...
   * current vote period.
   */
  aggregatePrevotes?: V1AggregateExchangeRatePrevote[];
}
...
export interface V1QueryAggregateVoteResponse {
   ...
   */
  aggregateVote?: V1AggregateExchangeRateVote;
}
...
export interface V1QueryAggregateVotesResponse {
   ...
   * vote period.
   */
  aggregateVotes?: V1AggregateExchangeRateVote[];
}
...
/**
 * @title merlion/oracle/v1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/merlion/oracle/v1/denoms/actives
   */
  queryActives = (params: RequestParams = {}) =>
    this.request<V1QueryActivesResponse, RpcStatus>({
      path: `/merlion/oracle/v1/denoms/actives`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/denoms/exchange_rates
   */
  queryExchangeRates = (params: RequestParams = {}) =>
    this.request<V1QueryExchangeRatesResponse, RpcStatus>({
      path: `/merlion/oracle/v1/denoms/exchange_rates`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/denoms/targets
   */
  queryTargets = (params: RequestParams = {}) =>
    this.request<V1QueryTargetsResponse, RpcStatus>({
      path: `/merlion/oracle/v1/denoms/targets`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/denoms/vote_targets
   */
  queryVoteTargets = (params: RequestParams = {}) =>
    this.request<V1QueryVoteTargetsResponse, RpcStatus>({
      path: `/merlion/oracle/v1/denoms/vote_targets`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/denoms/{denom}/exchange_rate
   */
  queryExchangeRate = (denom: string, params: RequestParams = {}) =>
    this.request<V1QueryExchangeRateResponse, RpcStatus>({
      path: `/merlion/oracle/v1/denoms/${denom}/exchange_rate`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/tx/aggregate_exchange_rate_prevote
   */
  msgAggregateExchangeRatePrevote = (
    ...
    this.request<V1MsgAggregateExchangeRatePrevoteResponse, RpcStatus>({
      path: `/merlion/oracle/v1/tx/aggregate_exchange_rate_prevote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/merlion/oracle/v1/tx/aggregate_exchange_rate_vote
   */
  msgAggregateExchangeRateVote = (
    query?: { salt?: string; exchangeRates?: string; feeder?: string; validator?: string },
    params: RequestParams = {},
  ) =>
    this.request<V1MsgAggregateExchangeRateVoteResponse, RpcStatus>({
      path: `/merlion/oracle/v1/tx/aggregate_exchange_rate_vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/merlion/oracle/v1/tx/delegate_feed_consent
   */
  msgDelegateFeedConsent = (query?: { operator?: string; delegate?: string }, params: RequestParams = {}) =>
    this.request<V1MsgDelegateFeedConsentResponse, RpcStatus>({
      path: `/merlion/oracle/v1/tx/delegate_feed_consent`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/merlion/oracle/v1/valdiators/{validatorAddr}/aggregate_vote
   */
  queryAggregateVote = (validatorAddr: string, params: RequestParams = {}) =>
    this.request<V1QueryAggregateVoteResponse, RpcStatus>({
      path: `/merlion/oracle/v1/valdiators/${validatorAddr}/aggregate_vote`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/validators/aggregate_prevotes
   */
  queryAggregatePrevotes = (params: RequestParams = {}) =>
    this.request<V1QueryAggregatePrevotesResponse, RpcStatus>({
      path: `/merlion/oracle/v1/validators/aggregate_prevotes`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/validators/aggregate_votes
   */
  queryAggregateVotes = (params: RequestParams = {}) =>
    this.request<V1QueryAggregateVotesResponse, RpcStatus>({
      path: `/merlion/oracle/v1/validators/aggregate_votes`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/validators/{validatorAddr}/aggregate_prevote
   */
  queryAggregatePrevote = (validatorAddr: string, params: RequestParams = {}) =>
    this.request<V1QueryAggregatePrevoteResponse, RpcStatus>({
      path: `/merlion/oracle/v1/validators/${validatorAddr}/aggregate_prevote`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlion/oracle/v1/validators/{validatorAddr}/miss
   */
  queryMissCounter = (validatorAddr: string, params: RequestParams = {}) =>
    this.request<V1QueryMissCounterResponse, RpcStatus>({
      path: `/merlion/oracle/v1/validators/${validatorAddr}/miss`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/merlionzone/merlion/oracle/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1QueryParamsResponse, RpcStatus>({
      path: `/merlionzone/merlion/oracle/params`,
      method: "GET",
      format: "json",
      ...params,
    });
