...
import { VeValidator } from "./module/types/merlion/staking/v1/staking"
import { VeDelegation } from "./module/types/merlion/staking/v1/staking"
import { VeShares } from "./module/types/merlion/staking/v1/staking"
import { VeUnbondingDelegation } from "./module/types/merlion/staking/v1/staking"
import { VeUnbondingDelegationEntry } from "./module/types/merlion/staking/v1/staking"
import { VeUnbondingDelegationEntryBalances } from "./module/types/merlion/staking/v1/staking"
import { VeRedelegation } from "./module/types/merlion/staking/v1/staking"
import { VeRedelegationEntry } from "./module/types/merlion/staking/v1/staking"
import { VeRedelegationEntryShares } from "./module/types/merlion/staking/v1/staking"
import { VeTokens } from "./module/types/merlion/staking/v1/staking"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: merlion.staking.v1 initialized!')
		...
		async MsgVeDelegate({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgVeDelegate', 'API Node Unavailable. Could not perform query: ' + e.message)
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgVeDelegate:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgVeDelegate:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
		...
		async MsgVeDelegate({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgVeDelegate:Create', 'Could not create message: ' + e.message)
