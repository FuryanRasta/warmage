...
import { Params } from "./module/types/merlion/maker/v1/genesis"
import { BackingRiskParams } from "./module/types/merlion/maker/v1/maker"
import { CollateralRiskParams } from "./module/types/merlion/maker/v1/maker"
import { RegisterBackingProposal } from "./module/types/merlion/maker/v1/maker"
import { RegisterCollateralProposal } from "./module/types/merlion/maker/v1/maker"
import { SetBackingRiskParamsProposal } from "./module/types/merlion/maker/v1/maker"
import { SetCollateralRiskParamsProposal } from "./module/types/merlion/maker/v1/maker"
import { BatchBackingRiskParams } from "./module/types/merlion/maker/v1/maker"
import { BatchSetBackingRiskParamsProposal } from "./module/types/merlion/maker/v1/maker"
import { BatchCollateralRiskParams } from "./module/types/merlion/maker/v1/maker"
import { BatchSetCollateralRiskParamsProposal } from "./module/types/merlion/maker/v1/maker"
import { TotalBacking } from "./module/types/merlion/maker/v1/maker"
import { PoolBacking } from "./module/types/merlion/maker/v1/maker"
import { AccountBacking } from "./module/types/merlion/maker/v1/maker"
import { TotalCollateral } from "./module/types/merlion/maker/v1/maker"
import { PoolCollateral } from "./module/types/merlion/maker/v1/maker"
import { AccountCollateral } from "./module/types/merlion/maker/v1/maker"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: merlion.maker.v1 initialized!')
		...
		async QueryAllBackingRiskParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAllBackingRiskParams', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryAllCollateralRiskParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAllCollateralRiskParams', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryAllBackingPools({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAllBackingPools', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryAllCollateralPools({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryAllCollateralPools', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryBackingPool({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryBackingPool', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryCollateralPool({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryCollateralPool', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryCollateralOfAccount({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryCollateralOfAccount', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryTotalBacking({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryTotalBacking', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryTotalCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryTotalCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryBackingRatio({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryBackingRatio', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateMintBySwapIn({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateMintBySwapIn', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateMintBySwapOut({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateMintBySwapOut', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateBurnBySwapIn({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateBurnBySwapIn', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateBurnBySwapOut({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateBurnBySwapOut', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateBuyBackingIn({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateBuyBackingIn', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateBuyBackingOut({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateBuyBackingOut', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateSellBackingIn({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateSellBackingIn', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryEstimateSellBackingOut({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:QueryEstimateSellBackingOut', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgMintBySwap({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgMintBySwap', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgBurnBySwap({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgBurnBySwap', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgBuyBacking({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgBuyBacking', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgSellBacking({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgSellBacking', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgMintByCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgMintByCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgBurnByCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgBurnByCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgDepositCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgDepositCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgRedeemCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgRedeemCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgLiquidateCollateral({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new SpVuexError('QueryClient:MsgLiquidateCollateral', 'API Node Unavailable. Could not perform query: ' + e.message)
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgBurnBySwap:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgBurnBySwap:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgSellBacking:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgSellBacking:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgBuyBacking:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgBuyBacking:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgMintByCollateral:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgMintByCollateral:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgRedeemCollateral:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgRedeemCollateral:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgMintBySwap:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgMintBySwap:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgBurnByCollateral:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgBurnByCollateral:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgDepositCollateral:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgDepositCollateral:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new SpVuexError('TxClient:MsgLiquidateCollateral:Init', 'Could not initialize signing client. Wallet is required.')
				}else{
					throw new SpVuexError('TxClient:MsgLiquidateCollateral:Send', 'Could not broadcast Tx: '+ e.message)
				}
			}
		},
		...
		async MsgBurnBySwap({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgBurnBySwap:Create', 'Could not create message: ' + e.message)
		...
		async MsgSellBacking({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgSellBacking:Create', 'Could not create message: ' + e.message)
		...
		async MsgBuyBacking({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgBuyBacking:Create', 'Could not create message: ' + e.message)
		...
		async MsgMintByCollateral({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgMintByCollateral:Create', 'Could not create message: ' + e.message)
		...
		async MsgRedeemCollateral({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgRedeemCollateral:Create', 'Could not create message: ' + e.message)
		...
		async MsgMintBySwap({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgMintBySwap:Create', 'Could not create message: ' + e.message)
		...
		async MsgBurnByCollateral({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgBurnByCollateral:Create', 'Could not create message: ' + e.message)
		...
		async MsgDepositCollateral({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgDepositCollateral:Create', 'Could not create message: ' + e.message)
		...
		async MsgLiquidateCollateral({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new SpVuexError('TxClient:MsgLiquidateCollateral:Create', 'Could not create message: ' + e.message)
