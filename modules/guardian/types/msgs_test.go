...
func TestMsgAddSuperGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"warmage/guardian/MsgAddSuper","value":{"added_by":"iaa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgwp4wlf","address":"iaa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmakdj4g","description":"description"}}`
...
func TestMsgDeleteSuperGetSignBytes(t *testing.T) {
	msg := NewMsgDeleteSuper(testAddr, sender)
	res := msg.GetSignBytes()
	expected := `{"type":"warmage/guardian/MsgDeleteSuper","value":{"address":"iaa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmakdj4g","deleted_by":"iaa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgwp4wlf"}}`
	require.Equal(t, expected, string(res))
}
