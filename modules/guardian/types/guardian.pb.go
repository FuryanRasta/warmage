...
type Super struct {
	...
	AccountType AccountType `protobuf:"varint,2,opt,name=account_type,json=accountType,proto3,enum=warmage.guardian.AccountType" json:"account_type,omitempty" yaml:"account_type"`
...
func init() {
	proto.RegisterEnum("warmage.guardian.AccountType", AccountType_name, AccountType_value)
	proto.RegisterType((*Super)(nil), "warmage.guardian.Super")
}
