...
func init() {
	proto.RegisterType((*QuerySupersRequest)(nil), "warmage.guardian.QuerySupersRequest")
	proto.RegisterType((*QuerySupersResponse)(nil), "warmage.guardian.QuerySupersResponse")
}
...
func (c *queryClient) Supers(ctx context.Context, in *QuerySupersRequest, opts ...grpc.CallOption) (*QuerySupersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/warmage.guardian.Query/Supers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Supers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/warmage.guardian.Query/Supers",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "warmage.guardian.Query",
